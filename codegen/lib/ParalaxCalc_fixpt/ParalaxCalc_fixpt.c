 ...
 * Return Type  : void
 */
void ParalaxCalc_fixpt(uint32_T az_in, int32_T el_in, uint32_T r_in, uint32_T
  *az_out, int32_T *el_out, uint32_T *r_out)
{
  static const int64m_T r28 = { { 0U, 118784U }/* chunks */
  };

  static const int64m_T r31 = { { 0U, 69632U }/* chunks */
  };

  static const int64m_T r33 = { { 0U, 45056U }/* chunks */
  };

  static const int64m_T r34 = { { 0U, 0U }/* chunks */
  };

  static const int64m_T r50 = { { 1073741824U, 421657428U }/* chunks */
  };
  ...
  sLong2MultiWord(MultiWord2sLong((uint32_T *)(&r25.chunks[0U])), (uint32_T *)
                  (&r21.chunks[0U]), 2);
  uMultiWordShl((uint32_T *)(&r21.chunks[0U]), 2, 30U, (uint32_T *)(&r22.chunks
    [0U]), 2);
  r21 = r28;
  MultiWordAdd((uint32_T *)(&r22.chunks[0U]), (uint32_T *)(&r28.chunks[0U]),
               (uint32_T *)(&r18.chunks[0U]), 2);
  sMultiWordShr((uint32_T *)(&r18.chunks[0U]), 2, 30U, (uint32_T *)(&r19.chunks
    [0U]), 2);
  ...
  ssuMultiWordMul((uint32_T *)(&u1), 1, (uint32_T *)(&r_in), 1, (uint32_T *)
                  (&r29.chunks[0U]), 2);
  uMultiWordShl((uint32_T *)(&r29.chunks[0U]), 2, 16U, (uint32_T *)(&r30.chunks
    [0U]), 2);
  ...
  sMultiWordMul((uint32_T *)(&r30.chunks[0U]), 2, (uint32_T *)(&u1), 1,
                (uint32_T *)(&r9.chunks[0U]), 3);
  sMultiWordShr((uint32_T *)(&r9.chunks[0U]), 3, 16U, (uint32_T *)(&r10.chunks
    [0U]), 3);
  sMultiWord2MultiWord((uint32_T *)(&r10.chunks[0U]), 3, (uint32_T *)
  ...
  sLong2MultiWord(MultiWord2sLong((uint32_T *)(&r27.chunks[0U])), (uint32_T *)
                  (&r24.chunks[0U]), 2);
  uMultiWordShl((uint32_T *)(&r24.chunks[0U]), 2, 30U, (uint32_T *)(&r21.chunks
    [0U]), 2);
  r24 = r31;
  MultiWordAdd((uint32_T *)(&r21.chunks[0U]), (uint32_T *)(&r31.chunks[0U]),
               (uint32_T *)(&r22.chunks[0U]), 2);
  sMultiWordShr((uint32_T *)(&r22.chunks[0U]), 2, 30U, (uint32_T *)(&r18.chunks
    [0U]), 2);
  ...
  ssuMultiWordMul((uint32_T *)(&u1), 1, (uint32_T *)(&r_in), 1, (uint32_T *)
                  (&r32.chunks[0U]), 2);
  uMultiWordShl((uint32_T *)(&r32.chunks[0U]), 2, 16U, (uint32_T *)(&r29.chunks
    [0U]), 2);
  sMultiWordShr((uint32_T *)(&r29.chunks[0U]), 2, 32U, (uint32_T *)(&r30.chunks
    [0U]), 2);
  sLong2MultiWord(MultiWord2sLong((uint32_T *)(&r30.chunks[0U])), (uint32_T *)
                  (&r26.chunks[0U]), 2);
  uMultiWordShl((uint32_T *)(&r26.chunks[0U]), 2, 30U, (uint32_T *)(&r24.chunks
    [0U]), 2);
  r26 = r33;
  MultiWordAdd((uint32_T *)(&r24.chunks[0U]), (uint32_T *)(&r33.chunks[0U]),
               (uint32_T *)(&r21.chunks[0U]), 2);
  sMultiWordShr((uint32_T *)(&r21.chunks[0U]), 2, 30U, (uint32_T *)(&r22.chunks
    [0U]), 2);
  ...
  sMultiWordMul((uint32_T *)(&u1), 1, (uint32_T *)(&u), 1, (uint32_T *)
                (&r29.chunks[0U]), 2);
  sMultiWordShr((uint32_T *)(&r29.chunks[0U]), 2, 1U, (uint32_T *)(&r26.chunks
    [0U]), 2);
  u1 = (uint32_T)y_out;
  u = (uint32_T)y_out;
  sMultiWordMul((uint32_T *)(&u1), 1, (uint32_T *)(&u), 1, (uint32_T *)
                (&r32.chunks[0U]), 2);
  sMultiWordShr((uint32_T *)(&r32.chunks[0U]), 2, 1U, (uint32_T *)(&r29.chunks
    [0U]), 2);
  MultiWordAdd((uint32_T *)(&r26.chunks[0U]), (uint32_T *)(&r29.chunks[0U]),
  ...
  y = 0;
  if (!sMultiWordLe((uint32_T *)(&c.chunks[0U]), (uint32_T *)(&r34.chunks[0U]),
                    2)) {
  ...
  *r_out = (((uint32_T)y) << 1U);
  ...
  y = 0;
  if (!sMultiWordLe((uint32_T *)(&b_c.chunks[0U]), (uint32_T *)(&r34.chunks[0U]),
                    2)) {
    for (el_in_rad = 30; el_in_rad >= 0; el_in_rad--) {
      ytemp = y | (1 << ((uint32_T)el_in_rad));
      u1 = (uint32_T)ytemp;
      ...
      sMultiWordMul((uint32_T *)(&u1), 1, (uint32_T *)(&u), 1, (uint32_T *)
                    (&r29.chunks[0U]), 2);
      sMultiWord2MultiWord((uint32_T *)(&r29.chunks[0U]), 2, (uint32_T *)
                           (&r9.chunks[0U]), 3);
  ...
  guard2 = false;
  if (z_out > 0) {
    sLong2MultiWord(y, (uint32_T *)(&r35.chunks[0U]), 2);
    ...
    MultiWordSignedWrap((uint32_T *)(&r35.chunks[0U]), 2, 31U, (uint32_T *)
                        (&r36.chunks[0U]));
    if (sMultiWordEq((uint32_T *)(&r37.chunks[0U]), (uint32_T *)(&r36.chunks[0U]),
                     2)) {
      thPreCorr = 6434;
    } else if (y >= 0) {
      sLong2MultiWord(z_out, (uint32_T *)(&r38.chunks[0U]), 2);
      MultiWordSignedWrap((uint32_T *)(&r38.chunks[0U]), 2, 31U, (uint32_T *)
                          (&r39.chunks[0U]));
      sLong2MultiWord(y, (uint32_T *)(&r41.chunks[0U]), 2);
      uMultiWordShl((uint32_T *)(&r41.chunks[0U]), 2, 1U, (uint32_T *)
                    (&r43.chunks[0U]), 2);
      MultiWordSignedWrap((uint32_T *)(&r43.chunks[0U]), 2, 31U, (uint32_T *)
                          (&r38.chunks[0U]));
      if (sMultiWordLe((uint32_T *)(&r39.chunks[0U]), (uint32_T *)(&r38.chunks
            [0U]), 2)) {
        if (y == 0) {
      ...
      sLong2MultiWord(z_out, (uint32_T *)(&r42.chunks[0U]), 2);
      MultiWordSignedWrap((uint32_T *)(&r42.chunks[0U]), 2, 31U, (uint32_T *)
                          (&r35.chunks[0U]));
      sLong2MultiWord(negThisX, (uint32_T *)(&r44.chunks[0U]), 2);
      uMultiWordShl((uint32_T *)(&r44.chunks[0U]), 2, 1U, (uint32_T *)
                    (&r45.chunks[0U]), 2);
      MultiWordSignedWrap((uint32_T *)(&r45.chunks[0U]), 2, 31U, (uint32_T *)
                          (&r42.chunks[0U]));
      if (sMultiWordEq((uint32_T *)(&r35.chunks[0U]), (uint32_T *)(&r42.chunks
            [0U]), 2)) {
        thPreCorr = 19302;
      } else {
        sLong2MultiWord(z_out, (uint32_T *)(&r44.chunks[0U]), 2);
        MultiWordSignedWrap((uint32_T *)(&r44.chunks[0U]), 2, 31U, (uint32_T *)(
          &r45.chunks[0U]));
        sLong2MultiWord(negThisX, (uint32_T *)(&r38.chunks[0U]), 2);
        uMultiWordShl((uint32_T *)(&r38.chunks[0U]), 2, 1U, (uint32_T *)
                      (&r39.chunks[0U]), 2);
        MultiWordSignedWrap((uint32_T *)(&r39.chunks[0U]), 2, 31U, (uint32_T *)(
          &r44.chunks[0U]));
        if (sMultiWordLt((uint32_T *)(&r45.chunks[0U]), (uint32_T *)
                         (&r44.chunks[0U]), 2)) {
    ...
    MultiWordSignedWrap((uint32_T *)(&r35.chunks[0U]), 2, 31U, (uint32_T *)
                        (&r32.chunks[0U]));
    if (sMultiWordEq((uint32_T *)(&r29.chunks[0U]), (uint32_T *)(&r32.chunks[0U]),
                     2)) {
      thPreCorr = -19302;
    } else if (y >= 0) {
      ...
      MultiWordSignedWrap((uint32_T *)(&r44.chunks[0U]), 2, 31U, (uint32_T *)
                          (&r45.chunks[0U]));
      sLong2MultiWord(y, (uint32_T *)(&r42.chunks[0U]), 2);
      uMultiWordShl((uint32_T *)(&r42.chunks[0U]), 2, 1U, (uint32_T *)
                    (&r38.chunks[0U]), 2);
      MultiWordSignedWrap((uint32_T *)(&r38.chunks[0U]), 2, 31U, (uint32_T *)
                          (&r44.chunks[0U]));
      if (sMultiWordEq((uint32_T *)(&r45.chunks[0U]), (uint32_T *)(&r44.chunks
            [0U]), 2)) {
        thPreCorr = -6434;
      } else {
        sLong2MultiWord(el_in_rad, (uint32_T *)(&r42.chunks[0U]), 2);
        MultiWordSignedWrap((uint32_T *)(&r42.chunks[0U]), 2, 31U, (uint32_T *)(
          &r38.chunks[0U]));
        ...
        MultiWordSignedWrap((uint32_T *)(&r41.chunks[0U]), 2, 31U, (uint32_T *)(
          &r42.chunks[0U]));
        if (sMultiWordLt((uint32_T *)(&r38.chunks[0U]), (uint32_T *)
                         (&r42.chunks[0U]), 2)) {
          if (y == 0) {
            idxUFIX16 = MAX_uint16_T;
          } else {
      ...
      MultiWordSignedWrap((uint32_T *)(&r45.chunks[0U]), 2, 31U, (uint32_T *)
                          (&r42.chunks[0U]));
      if (sMultiWordLe((uint32_T *)(&r35.chunks[0U]), (uint32_T *)(&r42.chunks
            [0U]), 2)) {
  ...
  if (guard2) {
    ...
    MultiWordSignedWrap((uint32_T *)(&r41.chunks[0U]), 2, 31U, (uint32_T *)
                        (&r43.chunks[0U]));
    sLong2MultiWord(z_out, (uint32_T *)(&r40.chunks[0U]), 2);
    MultiWordSignedWrap((uint32_T *)(&r40.chunks[0U]), 2, 31U, (uint32_T *)
                        (&r41.chunks[0U]));
    sLong2MultiWord(z_out, (uint32_T *)(&r49.chunks[0U]), 2);
    MultiWordSignedWrap((uint32_T *)(&r49.chunks[0U]), 2, 31U, (uint32_T *)
                        (&r40.chunks[0U]));
    sLong2MultiWord(negThisX, (uint32_T *)(&r51.chunks[0U]), 2);
    uMultiWordShl((uint32_T *)(&r51.chunks[0U]), 2, 1U, (uint32_T *)
                  (&r52.chunks[0U]), 2);
    MultiWordSignedWrap((uint32_T *)(&r52.chunks[0U]), 2, 31U, (uint32_T *)
                        (&r49.chunks[0U]));
    if (y >= 0) {
      if (sMultiWordLt((uint32_T *)(&r43.chunks[0U]), (uint32_T *)(&r41.chunks
            [0U]), 2)) {
        thPreCorr = (int16_T)(12867 - thPreCorr);
      }
    } else if (sMultiWordGt((uint32_T *)(&r40.chunks[0U]), (uint32_T *)
                            (&r49.chunks[0U]), 2)) {
  ...
  if (guard1) {
    ...
    MultiWordSignedWrap((uint32_T *)(&r39.chunks[0U]), 2, 31U, (uint32_T *)
                        (&r41.chunks[0U]));
    sLong2MultiWord(y, (uint32_T *)(&r43.chunks[0U]), 2);
    uMultiWordShl((uint32_T *)(&r43.chunks[0U]), 2, 1U, (uint32_T *)
                  (&r40.chunks[0U]), 2);
    MultiWordSignedWrap((uint32_T *)(&r40.chunks[0U]), 2, 31U, (uint32_T *)
                        (&r39.chunks[0U]));
    ...
    MultiWordSignedWrap((uint32_T *)(&r43.chunks[0U]), 2, 31U, (uint32_T *)
                        (&r40.chunks[0U]));
    sLong2MultiWord(negThisX, (uint32_T *)(&r36.chunks[0U]), 2);
    uMultiWordShl((uint32_T *)(&r36.chunks[0U]), 2, 1U, (uint32_T *)
                  (&r37.chunks[0U]), 2);
    MultiWordSignedWrap((uint32_T *)(&r37.chunks[0U]), 2, 31U, (uint32_T *)
                        (&r43.chunks[0U]));
    if (y >= 0) {
      if (sMultiWordLe((uint32_T *)(&r41.chunks[0U]), (uint32_T *)(&r39.chunks
            [0U]), 2)) {
  ...
  if (el_in_rad < 0) {
    sLong2MultiWord(el_in_rad, (uint32_T *)(&r46.chunks[0U]), 2);
    uMultiWordShl((uint32_T *)(&r46.chunks[0U]), 2, 30U, (uint32_T *)
                  (&r48.chunks[0U]), 2);
    r46 = r50;
    MultiWordAdd((uint32_T *)(&r48.chunks[0U]), (uint32_T *)(&r50.chunks[0U]),
                 (uint32_T *)(&r51.chunks[0U]), 2);
    sMultiWordShr((uint32_T *)(&r51.chunks[0U]), 2, 30U, (uint32_T *)
                  (&r52.chunks[0U]), 2);
    el_in_rad = MultiWord2sLong((uint32_T *)(&r52.chunks[0U]));
  }

  sLong2MultiWord(el_in_rad, (uint32_T *)(&r47.chunks[0U]), 2);
  uMultiWordShl((uint32_T *)(&r47.chunks[0U]), 2, 31U, (uint32_T *)(&r46.chunks
    [0U]), 2);
  u1 = 1367130551U;
  ssuMultiWordMul((uint32_T *)(&r46.chunks[0U]), 2, (uint32_T *)(&u1), 1,
  ...
  sMultiWord2MultiWord((uint32_T *)(&r8.chunks[0U]), 3, (uint32_T *)
                       (&r48.chunks[0U]), 2);
  sMultiWordShr((uint32_T *)(&r48.chunks[0U]), 2, 29U, (uint32_T *)(&r51.chunks
    [0U]), 2);
  *az_out = MultiWord2uLong((uint32_T *)(&r51.chunks[0U]));
  sLong2MultiWord(((int32_T)thPreCorr) * 131072, (uint32_T *)(&r53.chunks[0U]),
                  2);
  uMultiWordShl((uint32_T *)(&r53.chunks[0U]), 2, 31U, (uint32_T *)(&r47.chunks
    [0U]), 2);
  ssuMultiWordMul((uint32_T *)(&r47.chunks[0U]), 2, (uint32_T *)(&u1), 1,
                  (uint32_T *)(&r7.chunks[0U]), 3);
  sMultiWordShr((uint32_T *)(&r7.chunks[0U]), 3, 31U, (uint32_T *)(&r8.chunks[0U]),
                3);
  sMultiWord2MultiWord((uint32_T *)(&r8.chunks[0U]), 3, (uint32_T *)
                       (&r46.chunks[0U]), 2);
  sMultiWordShr((uint32_T *)(&r46.chunks[0U]), 2, 30U, (uint32_T *)(&r48.chunks
    [0U]), 2);
  *el_out = MultiWord2sLong((uint32_T *)(&r48.chunks[0U]));
